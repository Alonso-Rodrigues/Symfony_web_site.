...
class PricingPlan
{
    ...
    #[ORM\OneToMany(mappedBy: 'pricingPlan', targetEntity: PrincingPlanBenefit::class)]
    ...
    /**
     * @return Collection<int, PrincingPlanBenefit>
     */
    ...
    public function addBenefit(PrincingPlanBenefit $benefit): static
    {
    ...
    public function removeBenefit(PrincingPlanBenefit $benefit): static
    {
